...
Config.UseOldESX = false        --Enable this if you use Any Esx Version between 1.2 and V1 Final, This Script will not work with Esx 1.1
...
Config.Jobs = {
    ...
    {J = "Bringe Holz vom Hafen zum Sägewerk", D = "hard", EXP = 9999, S = vector3(-1246.1454, -3296.5305, 5.7625), SH = 204.0312, F = vector3(-556.9644, 5379.0376, 70.0815), V = "hauler", T = "TrailerLogs", TT = vector3(1284.8077, -3317.3938, 5.9031), TH = 79.9587, R = 1},
    {J = "Bringe Weizen vom Hafen zur Farm", D = "normal", EXP = 100, S = vector3(-1246.1454, -3296.5305, 5.7625), SH = 263.26065, F = vector3(1525.6123, 1719.6370, 109.9840), V = "hauler", T = "tr4", TT = vector3(1284.8077, -3317.3938, 5.9031), TH = 79.9587, R = 1},
    {J = "Bringe Autos zum Autohaus", D = "easy", EXP = 100, S = vector3(1248.1285, -3298.5332, 5.8972), SH = 263.26065, F = vector3(420, 420, 420), V = "hauler", T = "TR4", TT = vector3(1284.8077, -3317.3938, 5.9031), TH = 79.9587, R = 1},
