...
Config.Jobs = {
    ...
    {J = "Bringe Weizen vom Hafen zur Farm", D = "normal", EXP = 100, S = vector3(2021.9288, 4973.4497, 41.2550), SH = 278.9662, F = vector3(1525.6123, 1719.6370, 109.9840), V = "hauler", T = "BaleTrailer", TT = vector3(1288.6229, -3312.3245, 5.9719), TH = 87.5498, R = 1},
