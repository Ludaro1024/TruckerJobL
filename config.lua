...
Config.Jobs = {
    ...
    {J = "Bringe Holz vom Hafen zum Sägewerk", D = "hard", EXP = 200, S = vector3(-1246.1454, -3296.5305, 5.7625), SH = 204.0312, F = vector3(-556.9644, 5379.0376, 70.0815), V = "hauler", T = "TrailerLogs", TT = vector3(1284.8077, -3317.3938, 5.9031), TH = 79.9587, R = 1},
    {J = "Bringe Weizen vom Hafen zur Farm", D = "normal", EXP = 100, S = vector3(-1246.1454, -3296.5305, 5.7625), SH = 263.26065, F = vector3(1525.6123, 1719.6370, 109.9840), V = "hauler", T = "BaleTrailer", TT = vector3(1284.8077, -3317.3938, 5.9031), TH = 79.9587, R = 1},
